...
class ChangeSequenceTaskletTest {
    ...
    void executeSuccess() {
        SubscribeQuestionDao subscribeQuestionDao = mock(SubscribeQuestionDao.class);
        ChangeSequenceTasklet tasklet = new ChangeSequenceTasklet(subscribeQuestionDao);
        ...
        assertAll(
                () -> verify(subscribeQuestionDao, times(1)).increaseNextQuestionSequence(baseDateTime),
