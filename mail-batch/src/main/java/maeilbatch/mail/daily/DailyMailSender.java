...
@Slf4j
@Component("dailyMailSender")
public class DailyMailSender extends AbstractMailSender<DailyMailMessage> {

    private final SubscribeQuestionRepository subscribeQuestionRepository;

    public DailyMailSender(
    ...
    @Override
    protected void logSending(DailyMailMessage message) {
    ...
    @Override
    @Transactional
    protected void handleSuccess(DailyMailMessage message) {
    ...
    @Override
    protected void handleFailure(DailyMailMessage message) {
