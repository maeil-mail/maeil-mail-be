...
class MultipleChoiceOptionTest {
    ...
    void validateContentLength(String source) {
        MultipleChoiceQuestion question = mock(MultipleChoiceQuestion.class);

        assertThatThrownBy(() -> new MultipleChoiceOption(source, false, question))
    ...
    void validateContentMaxLength() {
        ...
        assertThatThrownBy(() -> new MultipleChoiceOption(invalidContent, false, question))
                .isInstanceOf(IllegalArgumentException.class)
